...
fn test_get_query_params() {
    assert_eq!(
        yew_router::parse_query::<HashMap<String, String>>().unwrap(),
        HashMap::new()
    );
    ...
    let params: HashMap<String, String> = yew_router::parse_query().unwrap();
...
fn test_build_base_url() {
    ...
    assert_eq!(build_path_with_base_prefix("/posts"), "/posts");
    ...
    assert_eq!(build_path_with_base_prefix("/posts/"), "/router/posts");
